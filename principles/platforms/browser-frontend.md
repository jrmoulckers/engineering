...
- Owner and ratification: Engineering owns this browser-security mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this browser capability and degradation mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this browser-performance mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this frontend-state and update-safety mechanism; only the repository owner may change a ratified principle.
