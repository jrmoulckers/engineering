...
- Owner and ratification: Engineering owns this Draft's generic dependency and boundary mechanism; only the repository owner may change it to Ratified.
...
- Owner and ratification: Engineering owns this Draft's generic software-contract mechanism; only the repository owner may change it to Ratified.
...
- Owner and ratification: Engineering owns this Draft's architecture-decision mechanism; only the repository owner may change it to Ratified.
...
- Owner and ratification: Engineering owns this Draft's deterministic-build property; only the repository owner may change it to Ratified.
