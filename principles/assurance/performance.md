...
- Owner and ratification: Engineering owns this performance-measurement mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this generic performance-budget mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this generic package-surface mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this cache-correctness mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this responsiveness mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this time-bounding mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this profiling mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this performance-regression triage mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this performance-precedence mechanism for correctness, privacy, and security; only the repository owner may change a ratified principle.
