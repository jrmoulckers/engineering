...
- Owner and ratification: Engineering owns this general test-portfolio mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this behavior-and-contract testing mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this regression-testing mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this static-assurance classification; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this deterministic-verification mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this risk-based coverage mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this polarity-and-precondition testing mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this test-failability mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this independent-test-evidence mechanism; only the repository owner may change a ratified principle.
...
- Owner and ratification: Engineering owns this executable-verification mechanism; only the repository owner may change a ratified principle.
